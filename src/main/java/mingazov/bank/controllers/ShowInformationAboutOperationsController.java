...
public class ShowInformationAboutOperationsController {
    ...
    public ResponseEntity<TransactionsResponseDTO> show(@RequestBody CustomerAuthenticateRequestDTO auth) {
